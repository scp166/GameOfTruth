...
(iii) The App does not store, send, and receive NFT (Master Card/Battle Card, etc.). This is because NFT (Master Card/Battle Card, etc.) exist only by virtue of the ownership record maintained on the App’s supporting blockchain. Any transfer of NFT (Master Card/Battle Card, etc.) occurs only on the Blockchain.
...
(v) any overt harmful act toward any other use of the Site, the App, and the Smart Contracts with whom you connected via the Site, the App, and the Smart Contracts.
